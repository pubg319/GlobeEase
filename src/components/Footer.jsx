	...
	return (
		<div className="py-5 text-center">
				<div className="container max-w-screen-lg mx-auto">
					<div>
						<div className="flex flex-wrap justify-center gap-2">
							<a 
								href="https://www.instagram.com/globeease/"
								className="bg-stone-400 p-3 font-semibold text-white inline-flex items-center space-x-5 rounded-full">
								<svg
			...
			<p className="text-sm mt-2  opacity-50">
				&copy; {new Date().getFullYear()} GlobeEase.
			</p>
		</div>
	);
}
